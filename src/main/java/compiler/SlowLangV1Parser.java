...
public class SlowLangV1Parser extends Parser {
	...
	public static final int CLASS = 1, MAIN = 2, IF = 3, ELSE = 4, WHILE = 5, RETURN = 6, NEW = 7, INT_TYPE = 8,
			FLOAT_TYPE = 9, STRING_TYPE = 10, INT = 11, FLOAT = 12, STRING = 13, ID = 14, WS = 15, ASSIGN = 16, OR = 17,
			AND = 18, EQ = 19, NE = 20, LT = 21, GT = 22, LE = 23, GE = 24, PLUS = 25, MINUS = 26, MULT = 27, DIV = 28,
			MOD = 29, NOT = 30, BIT_NOT = 31, INCR = 32, DECR = 33, LPAREN = 34, RPAREN = 35, LBRACE = 36, RBRACE = 37,
			LBRACK = 38, RBRACK = 39, SEMI = 40, COMMA = 41, DOT = 42;
	public static final int RULE_program = 0, RULE_mainExecBlock = 1, RULE_classDecl = 2, RULE_classBody = 3,
			RULE_fieldDecl = 4, RULE_methodDecl = 5, RULE_formalParams = 6, RULE_block = 7, RULE_statement = 8,
			RULE_ifStatement = 9, RULE_whileStatement = 10, RULE_returnStatement = 11, RULE_expression = 12,
			RULE_logicalOrExpr = 13, RULE_logicalAndExpr = 14, RULE_equalityExpr = 15, RULE_relationalExpr = 16,
			RULE_additiveExpr = 17, RULE_multiplicativeExpr = 18, RULE_unaryExpr = 19, RULE_assignmentExpr = 20,
			RULE_objectMethodCall = 21, RULE_functionCall = 22, RULE_primaryExpr = 23, RULE_prefixIncrDerc = 24,
			RULE_postfixIncrDerc = 25, RULE_objectCreation = 26, RULE_type = 27;

	private static String[] makeRuleNames() {
		return new String[] { "program", "mainExecBlock", "classDecl", "classBody", "fieldDecl", "methodDecl",
				"formalParams", "block", "statement", "ifStatement", "whileStatement", "returnStatement", "expression",
				"logicalOrExpr", "logicalAndExpr", "equalityExpr", "relationalExpr", "additiveExpr",
				"multiplicativeExpr", "unaryExpr", "assignmentExpr", "objectMethodCall", "functionCall", "primaryExpr",
	...
	private static String[] makeLiteralNames() {
		return new String[] { null, "'class'", "'main'", "'if'", "'else'", "'while'", "'return'", "'new'", "'int'",
				"'float'", "'string'", null, null, null, null, null, "'='", "'||'", "'&&'", "'=='", "'!='", "'<'",
				"'>'", "'<='", "'>='", "'+'", "'-'", "'*'", "'/'", "'%'", "'!'", "'~'", "'++'", "'--'", "'('", "')'",
				"'{'", "'}'", "'['", "']'", "';'", "','", "'.'" };
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] { null, "CLASS", "MAIN", "IF", "ELSE", "WHILE", "RETURN", "NEW", "INT_TYPE", "FLOAT_TYPE",
				"STRING_TYPE", "INT", "FLOAT", "STRING", "ID", "WS", "ASSIGN", "OR", "AND", "EQ", "NE", "LT", "GT",
				"LE", "GE", "PLUS", "MINUS", "MULT", "DIV", "MOD", "NOT", "BIT_NOT", "INCR", "DECR", "LPAREN", "RPAREN",
	...
	public static class ProgramContext extends ParserRuleContext {
		public TerminalNode EOF() {
			return getToken(SlowLangV1Parser.EOF, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterProgram(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitProgram(this);
		}
	}
	...
	public static class MainExecBlockContext extends ParserRuleContext {
		public TerminalNode MAIN() {
			return getToken(SlowLangV1Parser.MAIN, 0);
		}

		public TerminalNode LBRACE() {
			return getToken(SlowLangV1Parser.LBRACE, 0);
		}
		...
		public TerminalNode RBRACE() {
			return getToken(SlowLangV1Parser.RBRACE, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_mainExecBlock;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterMainExecBlock(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitMainExecBlock(this);
		}
	}
	...
	public static class ClassDeclContext extends ParserRuleContext {
		public TerminalNode CLASS() {
			return getToken(SlowLangV1Parser.CLASS, 0);
		}

		public TerminalNode ID() {
			return getToken(SlowLangV1Parser.ID, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterClassDecl(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitClassDecl(this);
		}
	}
	...
	public static class ClassBodyContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterClassBody(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitClassBody(this);
		}
	}
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << INT_TYPE) | (1L << FLOAT_TYPE) | (1L << STRING_TYPE) | (1L << ID))) != 0)) {
					{
						setState(80);
						_errHandler.sync(this);
	...
	public static class FieldDeclContext extends ParserRuleContext {
		...
		public TerminalNode SEMI() {
			return getToken(SlowLangV1Parser.SEMI, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterFieldDecl(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitFieldDecl(this);
		}
	}
	...
	public static class MethodDeclContext extends ParserRuleContext {
		...
		public TerminalNode LPAREN() {
			return getToken(SlowLangV1Parser.LPAREN, 0);
		}
		...
		public TerminalNode RPAREN() {
			return getToken(SlowLangV1Parser.RPAREN, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterMethodDecl(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitMethodDecl(this);
		}
	}
	...
	public static class FormalParamsContext extends ParserRuleContext {
		...
		public List<TerminalNode> ID() {
			return getTokens(SlowLangV1Parser.ID);
		}
		...
		public List<TerminalNode> COMMA() {
			return getTokens(SlowLangV1Parser.COMMA);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterFormalParams(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitFormalParams(this);
		}
	}
	...
	public static class BlockContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterBlock(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitBlock(this);
		}
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << WHILE) | (1L << RETURN)
						| (1L << NEW) | (1L << INT) | (1L << FLOAT) | (1L << STRING) | (1L << ID) | (1L << PLUS)
						| (1L << MINUS) | (1L << NOT) | (1L << BIT_NOT) | (1L << INCR) | (1L << DECR) | (1L << LPAREN)
						| (1L << LBRACE) | (1L << SEMI))) != 0)) {
					{
						{
							setState(111);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterStatement(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitStatement(this);
		}
	}
	...
	public static class IfStatementContext extends ParserRuleContext {
		public TerminalNode IF() {
			return getToken(SlowLangV1Parser.IF, 0);
		}
		...
		public TerminalNode ELSE() {
			return getToken(SlowLangV1Parser.ELSE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterIfStatement(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitIfStatement(this);
		}
	}
	...
	public static class WhileStatementContext extends ParserRuleContext {
		public TerminalNode WHILE() {
			return getToken(SlowLangV1Parser.WHILE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterWhileStatement(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitWhileStatement(this);
		}
	}
	...
	public static class ReturnStatementContext extends ParserRuleContext {
		public TerminalNode RETURN() {
			return getToken(SlowLangV1Parser.RETURN, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterReturnStatement(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitReturnStatement(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterExpression(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitExpression(this);
		}
	}
	...
	public static class LogicalOrExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> OR() {
			return getTokens(SlowLangV1Parser.OR);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterLogicalOrExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitLogicalOrExpr(this);
		}
	}
	...
	public static class LogicalAndExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> AND() {
			return getTokens(SlowLangV1Parser.AND);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterLogicalAndExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitLogicalAndExpr(this);
		}
	}
	...
	public static class EqualityExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> EQ() {
			return getTokens(SlowLangV1Parser.EQ);
		}
		...
		public List<TerminalNode> NE() {
			return getTokens(SlowLangV1Parser.NE);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterEqualityExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitEqualityExpr(this);
		}
	}
	...
	public static class RelationalExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> LT() {
			return getTokens(SlowLangV1Parser.LT);
		}
		...
		public List<TerminalNode> GT() {
			return getTokens(SlowLangV1Parser.GT);
		}
		...
		public List<TerminalNode> LE() {
			return getTokens(SlowLangV1Parser.LE);
		}
		...
		public List<TerminalNode> GE() {
			return getTokens(SlowLangV1Parser.GE);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterRelationalExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitRelationalExpr(this);
		}
	}
	...
	public static class AdditiveExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> PLUS() {
			return getTokens(SlowLangV1Parser.PLUS);
		}
		...
		public List<TerminalNode> MINUS() {
			return getTokens(SlowLangV1Parser.MINUS);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterAdditiveExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitAdditiveExpr(this);
		}
	}
	...
	public static class MultiplicativeExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> MULT() {
			return getTokens(SlowLangV1Parser.MULT);
		}
		...
		public List<TerminalNode> DIV() {
			return getTokens(SlowLangV1Parser.DIV);
		}
		...
		public List<TerminalNode> MOD() {
			return getTokens(SlowLangV1Parser.MOD);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterMultiplicativeExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitMultiplicativeExpr(this);
		}
	}
	...
	public static class UnaryExprContext extends ParserRuleContext {
		...
		public TerminalNode PLUS() {
			return getToken(SlowLangV1Parser.PLUS, 0);
		}

		public TerminalNode MINUS() {
			return getToken(SlowLangV1Parser.MINUS, 0);
		}

		public TerminalNode NOT() {
			return getToken(SlowLangV1Parser.NOT, 0);
		}

		public TerminalNode BIT_NOT() {
			return getToken(SlowLangV1Parser.BIT_NOT, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterUnaryExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitUnaryExpr(this);
		}
	}
	...
	public final UnaryExprContext unaryExpr() throws RecognitionException {
		...
		try {
			...
			case BIT_NOT:
				...
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << PLUS) | (1L << MINUS) | (1L << NOT) | (1L << BIT_NOT))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					if (_input.LA(1) == Token.EOF)
						matchedEOF = true;
	...
	public static class AssignmentExprContext extends ParserRuleContext {
		...
		public TerminalNode ASSIGN() {
			return getToken(SlowLangV1Parser.ASSIGN, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterAssignmentExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitAssignmentExpr(this);
		}
	}
	...
	public static class ObjectMethodCallContext extends ParserRuleContext {
		...
		public TerminalNode DOT() {
			return getToken(SlowLangV1Parser.DOT, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterObjectMethodCall(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitObjectMethodCall(this);
		}
	}
	...
	public final ObjectMethodCallContext objectMethodCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NEW) | (1L << INT) | (1L << FLOAT) | (1L << STRING)
						| (1L << ID) | (1L << PLUS) | (1L << MINUS) | (1L << NOT) | (1L << BIT_NOT) | (1L << INCR)
						| (1L << DECR) | (1L << LPAREN))) != 0)) {
					{
						setState(216);
						expression();
	...
	public static class FunctionCallContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterFunctionCall(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitFunctionCall(this);
		}
	}
	...
	public static class PrimaryExprContext extends ParserRuleContext {
		public TerminalNode INT() {
			return getToken(SlowLangV1Parser.INT, 0);
		}

		public TerminalNode FLOAT() {
			return getToken(SlowLangV1Parser.FLOAT, 0);
		}

		public TerminalNode STRING() {
			return getToken(SlowLangV1Parser.STRING, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterPrimaryExpr(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitPrimaryExpr(this);
		}
	}
	...
	public static class PrefixIncrDercContext extends ParserRuleContext {
		...
		public TerminalNode INCR() {
			return getToken(SlowLangV1Parser.INCR, 0);
		}

		public TerminalNode DECR() {
			return getToken(SlowLangV1Parser.DECR, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_prefixIncrDerc;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterPrefixIncrDerc(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitPrefixIncrDerc(this);
		}
	}
	...
	public static class PostfixIncrDercContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_postfixIncrDerc;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterPostfixIncrDerc(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitPostfixIncrDerc(this);
		}
	}
	...
	public static class ObjectCreationContext extends ParserRuleContext {
		public TerminalNode NEW() {
			return getToken(SlowLangV1Parser.NEW, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_objectCreation;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterObjectCreation(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitObjectCreation(this);
		}
	}
	...
	public static class TypeContext extends ParserRuleContext {
		public TerminalNode INT_TYPE() {
			return getToken(SlowLangV1Parser.INT_TYPE, 0);
		}

		public TerminalNode FLOAT_TYPE() {
			return getToken(SlowLangV1Parser.FLOAT_TYPE, 0);
		}

		public TerminalNode STRING_TYPE() {
			return getToken(SlowLangV1Parser.STRING_TYPE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).enterType(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof SlowLangV1ParserListener)
				((SlowLangV1ParserListener) listener).exitType(this);
		}
	}
	...
	public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3,\u0119\4\2\t\2\4"
